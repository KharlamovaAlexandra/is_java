...
//    @ResponseBody
    ...
    @RequestMapping(value = "/molnia", method = RequestMethod.POST, produces = "application/json")
    ...
    @RequestMapping(value = "/sport", method = RequestMethod.POST, produces = "application/json")
    ...
    @RequestMapping(value = "/recu", method = RequestMethod.POST, produces = "application/json")
    ...
    @RequestMapping(value = "/Pali", method = RequestMethod.POST, produces = "application/json")
    ...
    @RequestMapping(value = "/sytki", method = RequestMethod.POST, produces = "application/json")
